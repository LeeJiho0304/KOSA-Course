...
public class NoticeBoard {
	...
	public static void main(String[] args) {
		Scanner scanner = new Scanner(System.in); //scanner타입의 변수 scanner을 생성하고 scannner 객체를 생성했습니다.
		
		String[][] boards = new String[100][5]; // Strig타입 배열 선언, 길이가 100, 5인 배열목록을 null로 초기화해 저장했습니다.
		int boardNum = 0;  // 게시글 번호를 저장할 int 타입의 변수 boardNum을 선언하고 0으로 초기화 했습니다.
		boolean run = true; // while문의 조건식으로 사용할 boolean 타입 변수 run을 선언하고 true 값을 저장했습니다.
		
		Calendar today = Calendar.getInstance();  // 컴퓨터 날짜 및 시간정보를 가진 Calenar 객체를 얻고 번지를 today 변수에 대입헀습니다.
		int year = today.get(Calendar.YEAR);	// int 타입의 year 변수에 Calendar 객체
